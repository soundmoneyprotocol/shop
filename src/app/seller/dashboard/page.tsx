      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-400">Manage your products and track sales</p>
              </div>
              <button
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              {[
                ...
                {
                  label: 'Followers',
                  value: MOCK_SELLER.followers.toLocaleString(),
                  icon: Users,
                },
              ].map((stat, i) => {
                ...
                <div className="grid gap-6">
                  {products.map((product) => (
                    <motion.div
                      ...
                      whileHover={{ y: -2 }}
                    >
                      <div className="card flex items-center justify-between hover:border-primary transition">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <span className="text-primary">${(product.price / 100).toFixed(2)}</span>
        ...
        {activeTab === 'create' && (
          <motion.div
            ...
            transition={{ duration: 0.4 }}
          >
            <form onSubmit={handleCreateProduct} className="card max-w-2xl">
              <h2 className="text-2xl font-bold mb-8">List New Product</h2>

              <div className="space-y-6">
                {/* Product Title */}
                <div>
                  <label className="text-sm font-semibold text-slate-300 mb-2 block">Product Title *</label>
                  <input
                    type="text"
                    name="title"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-semibold text-slate-300 mb-2 block">Price (USD) *</label>
                    <input
                      type="number"
                      name="price"
                      placeholder="0.00"
                ...
                {/* Stock */}
                <div>
                  <label className="text-sm font-semibold text-slate-300 mb-2 block">Stock Quantity *</label>
                  <input
                    type="number"
                    name="stock"
                    placeholder="0"
                ...
                <div className="bg-slate-700/50 rounded-lg p-4">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <span className="font-semibold">Mint Authenticity NFT for each purchase</span>
                  </label>
                  <p className="text-sm text-slate-400 mt-2 ml-8">
                    Customers will receive an ERC1155 token proving ownership and authenticity
                  </p>
                </div>
