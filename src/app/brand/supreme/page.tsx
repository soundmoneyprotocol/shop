...
const BRAND = {
  id: 'supreme-brand',
  name: 'SUPREME',
  description: 'Iconic streetwear and limited edition drops',
  verified: true,
  rating: 4.8,
  reviews: 380,
  totalSales: 950,
...
const PRODUCTS: Product[] = [
  {
    ...
    price_usd: 85000,
    image_url: 'https://images.unsplash.com/photo-1556821552-919ad5de63c3?w=500&h=500&fit=crop',
    category: 'Apparel',
    rating: 4.9,
    stock: 2,
    creator_id: 'supreme-brand',
  },
  {
    id: 'supreme-2',
    title: 'Supreme Brick',
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-light text-gray-900 mb-8">Limited Drops</h2>
