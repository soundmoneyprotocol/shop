...
const BRAND = {
  id: 'yeezy-brand',
  name: 'YEEZY',
  description: 'Official YEEZY footwear and apparel',
  verified: true,
  rating: 4.9,
  reviews: 520,
  totalSales: 1450,
...
export default function YeezyPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-light text-gray-900 mb-8">Latest Collection</h2>
