  ...
  return (
    <main className="min-h-screen bg-dark py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Breadcrumb */}
        <motion.div className="mb-8 text-slate-400" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        {/* Tabs Section */}
        <motion.div className="mt-16 space-y-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          {/* Tab Navigation */}
